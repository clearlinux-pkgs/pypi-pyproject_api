...
Source0  : https://files.pythonhosted.org/packages/b8/ec/6f414433d8b924a000ff57e70ea3348182c93f36db77972753f6729b67ef/pyproject_api-1.2.1.tar.gz
...
%prep
%setup -q -n pyproject_api-1.2.1
cd %{_builddir}/pyproject_api-1.2.1
pushd ..
cp -a pyproject_api-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670889201
