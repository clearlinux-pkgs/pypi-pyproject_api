...
Source0  : https://files.pythonhosted.org/packages/86/92/a63e1fd25adfde23f21d87676a4dc39fb969d2979c60aac9d7b3425d6223/pyproject_api-1.5.0.tar.gz
...
%prep
%setup -q -n pyproject_api-1.5.0
cd %{_builddir}/pyproject_api-1.5.0
pushd ..
cp -a pyproject_api-1.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674056072
