...
Source0  : https://files.pythonhosted.org/packages/41/43/5581b42a96c5ee7bf2b22d3b08b34c8a54dfe6591d8b9a4314c890bd4a0d/pyproject_api-1.7.1.tar.gz
...
%prep
%setup -q -n pyproject_api-1.7.1
cd %{_builddir}/pyproject_api-1.7.1
pushd ..
cp -a pyproject_api-1.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719250115
